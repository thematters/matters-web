...
const XS: React.SFC = props => (
  <ContentLoader {...LoaderProps} width={343} height={631} {...props}>
...
const MD: React.SFC = props => (
  <ContentLoader {...LoaderProps} width={639} height={631} {...props}>
...
const LG: React.SFC = props => (
  <ContentLoader {...LoaderProps} width={704} height={631} {...props}>
...
const ArticleDigestList: React.SFC = props => (
  <>
    <Responsive.XSmall>
      <XS {...props} />
    </Responsive.XSmall>
