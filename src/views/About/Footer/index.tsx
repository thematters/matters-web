            ...
            <section className="followUs">
              ...
              <div className="socials">
                <a href="https://twitter.com/MattersLab" target="_blank">
                  {withIcon(IconFooterTwitter)({ size: 'md', color: 'white' })}
                </a>
                <a
                  href="https://www.facebook.com/MattersLab2018/"
                  target="_blank"
                >
                  {withIcon(IconFooterFacebook)({ size: 'md', color: 'white' })}
                </a>
                <a
                ...
                <Tooltip content="MattersLab">
                  <span>
                    {withIcon(IconFooterWeChat)({ size: 'md', color: 'white' })}
                  </span>
                </Tooltip>
                <a
                  ...
                  target="_blank"
                >
                  {withIcon(IconFooterTelegram)({ size: 'md', color: 'white' })}
                </a>
              </div>
            </section>
