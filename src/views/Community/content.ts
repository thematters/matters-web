...
<h4>社區約章</h4>
<p>根據香港法律與社區自治判例，針對以下行為，Matters 會做出刪除發言、禁言、凍結及註銷帳號等不同程度的處理：</p>
<ol>
  <li>發表極端歧視 <sup>[1]</sup>、嚴重侮辱性言詞和仇恨言論，包括宣揚暴力的威脅、挑釁。</li>
  <li>任何對未成年人進行性剝削或暴力剝削的內容，包括發佈兒童色情類內容。</li>
  <li>不註明轉載與原文出處、原文作者的惡意抄襲，包括但不限於無授權抄襲、無版權圖片，商標侵權等，及在香港的法律法規下任何可能引起民事或刑事責任的內容。</li>
  ...
  <li>惡意註冊批量帳號，在網頁刷讚和刷屏，損害社區與其他用戶權益的行為。</li>
  <li>發佈賭博、色情、藥品類廣告，或其他經過社區訴訟而被認定不應該在 Matters 社區進行的商業活動。</li>
</ol>
...
<h4>社区约章</h4>
<p>根据香港法律与社区自治判例，针对以下行为，Matters 会做出删除发言、禁言、冻结及注销帐号等不同程度的处理：</p>
<ol>
  <li>发表极端歧视 <sup>[1]</sup>、严重侮辱性言词和仇恨言论，包括宣扬暴力的威胁、挑衅。</li>
  <li>任何对未成年人进行性剥削或暴力剥削的内容，包括发布儿童色情类内容。</li>
  <li>不注明转载与原文出处、原文作者的恶意抄袭，包括但不限于无授权抄袭、无版权图片，商标侵权等，及在香港的法律法规下任何可能引起民事或刑事责任的内容。</li>
  ...
  <li>恶意注册批量帐号，在网页刷赞和刷屏，损害社区与其他用户权益的行为。</li>
