...
<ol>
  <li>發布極端歧視 <sup>[1]</sup>、嚴重侮辱性言詞和仇恨言論，包括宣揚暴力的威脅、挑釁。</li>
  <li>任何對未成年人進行性剝削或暴力剝削的內容，包括發布兒童色情類內容。</li>
  <li>不註明轉載與原文出處、原文作者的惡意抄襲，包括但不限於無授權抄襲、無版權圖片，商標侵權等，及在 Matters 適用法律法規下任何可能引起民事或刑事責任的內容。</li>
  ...
  <li>惡意註冊批量帳戶，在網頁刷讚和刷屏；重複發佈相似度高的內容，造成刷屏或用戶困擾；其他損害社區與其他用戶權益的行為。</li>
  <li>發佈推銷商品且帶有牟利性外鏈的商業廣告，包括但不限於賭博、色情、藥品類廣告，或其他經過社區訴訟而被認定不應該在 Matters 社區進行的商業活動。</li>
...
<ol>
  <li>发布极端歧视 <sup>[1]</sup>、严重侮辱性言词和仇恨言论，包括宣扬暴力的威胁、挑衅。</li>
  <li>任何对未成年人进行性剥削或暴力剥削的内容，包括发布儿童色情类内容。</li>
  <li>不注明转载与原文出处、原文作者的恶意抄袭，包括但不限于无授权抄袭、无版权图片，商标侵权等，及在 Matters 适用法律法规下任何可能引起民事或刑事责任的内容。</li>
  ...
  <li>恶意注册批量帐户，在网页刷赞和刷屏；重复发布相似度高的内容，造成刷屏或用户困扰；其他损害社区与其他用户权益的行为。</li>
  <li>发布推销商品且带有牟利性外链的商业广告，包括但不限于赌博、色情、药品类广告，或其他经过社区诉讼而被认定不应该在 Matters 社区进行的商业活动。</li>
