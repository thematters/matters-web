...
<h4>社區約章</h4>
<p>根據香港法律與社區自治判例，針對以下行為，Matters 會做出刪除發言、禁言、凍結及註銷帳戶等不同程度的處理：</p>
<ol>
  <li>發佈極端歧視 <sup>[1]</sup>、嚴重侮辱性言詞和仇恨言論，包括宣揚暴力的威脅、挑釁。</li>
...
<h4>社区约章</h4>
<p>根据香港法律与社区自治判例，针对以下行为，Matters 会做出删除发言、禁言、冻结及注销帐户等不同程度的处理：</p>
<ol>
