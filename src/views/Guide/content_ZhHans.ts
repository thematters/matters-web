...
*   [Matters 读者工具箱 | 新手必看](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387122)
*   [Matters 作者工具箱 | 新手必看](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387126)

Matters 目前尚未推出 App，如果你想要在手机上使用 ${process.env.NEXT_PUBLIC_SITE_BRAND_NAME}，非常推荐你使用 PWA，功能跟 App 几乎完全一样。

*   [Matters 应用下载（PWA）指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387115)
...
*   [Matters 加密钱包指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387112)

${process.env.NEXT_PUBLIC_SITE_BRAND_NAME} 的经济系统支援法币（港币）及 USDT、LikeCoin 等虚拟货币，欢迎你使用加密货币支持优质作者，也可以将获得的报酬提领出来。

*   [Matters 支付与提现指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387119)

如果你想用手机进行登入、绑定钱包及进行 USDT-Polygon 支付，请参考我们的手机版专属指南，可以为你解决绝大部分的疑惑。

*   [Matters 钱包与支付指南（手机版）](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387120)

好文章不遗漏，我们也支援 RSS 、JSON 阅读器或 IPNS 兼容的 Planet 阅读器来订阅作者。

*   [Matters 内容订阅使用指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/zh-Hans/@hi176/387116)
`
