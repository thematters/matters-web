...
*   [Matters 读者工具箱 | 新手必看](https://matters.town/zh-Hans/@hi176/387122)
*   [Matters 作者工具箱 | 新手必看](https://matters.town/zh-Hans/@hi176/387126)

Matters 目前尚未推出 App，如果你想要在手机上使用 ${process.env.NEXT_PUBLIC_SITE_BRAND_NAME}，非常推荐你使用 PWA，功能跟 App 几乎完全一样。

*   [Matters 应用下载（PWA）指南](https://matters.town/zh-Hans/@hi176/387115)
...
*   [Matters 加密钱包指南](https://matters.town/zh-Hans/@hi176/387112)

${process.env.NEXT_PUBLIC_SITE_BRAND_NAME} 的经济系统支援法币（港币）及 USDT、LikeCoin 等虚拟货币，欢迎你使用加密货币支持优质作者，也可以将获得的报酬提领出来。

*   [Matters 支付与提现指南](https://matters.town/zh-Hans/@hi176/387119)
...
*   [Matters 内容订阅使用指南](https://matters.town/zh-Hans/@hi176/387116)
`
