...
*   [Matters 讀者工具箱 | 新手必看](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387122)
*   [Matters 作者工具箱 | 新手必看](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387126)

Matters 目前尚未推出 App，如果你想要在手機上使用 ${process.env.NEXT_PUBLIC_SITE_BRAND_NAME}，非常推薦你使用 PWA，功能跟 App 幾乎完全一樣。

*   [Matters 應用下載（PWA）指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387115)
...
*   [Matters 加密錢包指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387112)

${process.env.NEXT_PUBLIC_SITE_BRAND_NAME} 的經濟系統支援法幣（港幣）及 USDT、LikeCoin 等虛擬貨幣，歡迎你使用加密貨幣支持優質作者，也可以將獲得的報酬提領出來。

*   [Matters 支付與提現指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387119)

如果你想用手機進行登入、綁定錢包及進行 USDT-Polygon 支付，請參考我們的手機版專屬指南，可以為你解決絕大部分的疑惑。

*   [Matters 錢包與支付指南（手機版）](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387120)

好文章不遺漏，我們也支援 RSS 、JSON 閱讀器或 IPNS 兼容的 Planet 閱讀器來訂閱作者。

*   [Matters 內容訂閱使用指南](https://${process.env.NEXT_PUBLIC_SITE_DOMAIN}/@hi176/387116)
`
