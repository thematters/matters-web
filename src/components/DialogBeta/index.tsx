...
export const DialogBeta: React.ComponentType<
  React.PropsWithChildren<DialogBetaProps>
> & {
...
DialogBeta.Header = Header
DialogBeta.Content = Content
DialogBeta.Footer = Footer
DialogBeta.TextButton = TextButton
DialogBeta.RoundedButton = RoundedButton
DialogBeta.Lazy = Lazy
