  ...
  return (
        ...
        window.dispatchEvent(
          new CustomEvent(ADD_TOAST, {
            detail: {
              color: 'green',
              content: (
                <FormattedMessage defaultMessage="Article has been added to Featured" description="src/components/ArticleDigest/DropdownActions/SetTagSelectedButton.tsx" />
              ),
              duration: 2000,
            },
          })
    ...
    >
      <TextIcon icon={<IconAdd24 size="md" />} size="md" spacing="base">
        <FormattedMessage defaultMessage="Add to Featured" description="src/components/ArticleDigest/DropdownActions/SetTagSelectedButton.tsx"/>
      </TextIcon>
    </Menu.Item>
  )
}
