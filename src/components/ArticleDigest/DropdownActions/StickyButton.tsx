    ...
    <Menu.Item onClick={toggleSticky}>
      {article.sticky ? (
        <TextIcon icon={<IconUnPin24 size="md" />} size="md" spacing="base">
          <FormattedMessage defaultMessage="Unpin" description="src/components/ArticleDigest/DropdownActions/StickyButton.tsx" />
        </TextIcon>
      ) : (
        <TextIcon icon={<IconPin24 size="md" />} size="md" spacing="base">
          <FormattedMessage defaultMessage="Article pinned" description="src/components/ArticleDigest/DropdownActions/StickyButton.tsx"/>
        </TextIcon>
      )}
    </Menu.Item>
  )
