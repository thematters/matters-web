...
// ====================================================
// GraphQL fragment: DigestRichCirclePrivate
// ====================================================

export interface DigestRichCirclePrivate_invitedBy {
...
export interface DigestRichCirclePrivate {
  __typename: "Circle";
  /**
   * Unique ID.
   */
   ...
   */
  invitedBy: DigestRichCirclePrivate_invitedBy | null;
}
