...
// ====================================================
// GraphQL fragment: PriceCirclePrivate
// ====================================================

export interface PriceCirclePrivate_invitedBy {
...
export interface PriceCirclePrivate {
  __typename: "Circle";
  /**
   * Unique ID.
   */
   ...
   */
  invitedBy: PriceCirclePrivate_invitedBy | null;
}
