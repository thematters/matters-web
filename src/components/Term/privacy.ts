...
<p>11.4 用戶理解並承認，用戶發布與轉發內容的風險由用戶自己承擔。雖然MATTERS會限制用戶對某些頁面的訪問，但用戶承認沒有任何安全措施是完美的萬無一失的。另外，用戶理解並承認，MATTERS無法控制其用戶選擇與誰共享內容。因此，用戶理解並承認，MATTERS不能也不保證其用戶內容一定不會被未經授權的人瀏覽。</p>
