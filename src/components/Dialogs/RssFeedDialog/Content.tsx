...
const RssFeedDialogContent = ({
  ...
  const gateways = data?.official.rssFeedGatewayUrls || []
      ...
      >
        ...
        <section className="gateways">
          ...
          <ul>
            ...
            {gateways.map((url) => {
              const gatewayUrl = url.replace(':hash', ipnsKey)
              const hostname = url.replace(/(https:\/\/|\/ipns\/|:hash.?)/g, '')
