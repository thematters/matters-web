...
export interface ClearJouranlDialogProps {
  onConfirm: () => void
  children: ({ openDialog }: { openDialog: () => void }) => React.ReactNode
}

const BaseDialog = ({ onConfirm, children }: ClearJouranlDialogProps) => {
...
export const ClearJournalDialog = (props: ClearJouranlDialogProps) => (
