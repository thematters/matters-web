...
import IconNavFollowing from '@/public/static/icons/24px/nav-following.svg'
import IconNavFollowingActive from '@/public/static/icons/24px/nav-following-active.svg'
