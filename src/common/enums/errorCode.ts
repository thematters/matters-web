...
export const ERROR_CODES = {
  ...
  USER_PASSWORD_NOT_AVAILABLE: 'USER_PASSWORD_NOT_AVAILABLE',

  // Tag
  DUPLICATE_TAG: 'DUPLICATE_TAG',
  TOO_MANY_TAGS_FOR_ARTICLE: 'TOO_MANY_TAGS_FOR_ARTICLE',
  NOT_ALLOW_ADD_TAG: 'NOT_ALLOW_ADD_TAG',
  NOT_ALLOW_ADD_OFFICIAL_TAG: 'NOT_ALLOW_ADD_OFFICIAL_TAG',
  ...
  NOTICE_PAYMENT_PAYOUT_ACCOUNT_EXISTS: 'NOTICE_PAYMENT_PAYOUT_ACCOUNT_EXISTS',
