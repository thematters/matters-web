...
export const TEXT = {
  zh_hant: {
    ...
    USER_EMAIL_NOT_FOUND: '郵件地址或密碼錯誤',
    USER_NOT_FOUND: '用戶不存在',
    USER_PASSWORD_INVALID: '郵件地址或密碼錯誤',
  ...
  zh_hans: {
    ...
    USER_EMAIL_NOT_FOUND: '邮箱或密码错误',
    USER_NOT_FOUND: '用户不存在',
    USER_PASSWORD_INVALID: '邮箱或密码错误',
    USER_PASSWORD_NOT_AVAILABLE:
  ...
  en: {
    ...
    CODE_INACTIVE: 'Incorrect email or password',
    ...
    USER_EMAIL_NOT_FOUND: 'Incorrect email or password',
    USER_NOT_FOUND: 'User not found',
    USER_PASSWORD_INVALID: 'Incorrect email or password',
    USER_PASSWORD_NOT_AVAILABLE:
