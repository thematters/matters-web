...
export const TEXT = {
  zh_hant: {
    ...
    bookmark: '收藏',
    cancel: '取消',
    callbackClose: '頁面即將關閉，請回到原頁面繼續操作',
    change: '修改',
    changeEmail: '修改電子信箱',
    changePassword: '修改密碼',
    ...
    enterPassword: '請輸入密碼',
    enterPaymentPasswordAgain: '请再次输入支付密码',
    ...
    hintPaymentPassword: '輸入六位數字支付密碼',
    ...
    successResetPaymentPassword: '支付密碼重置成功',
  ...
  zh_hans: {
    ...
    bookmark: '收藏',
    cancel: '取消',
    callbackClose: '页面即将关闭，请回到原页面继续操作',
    change: '修改',
    changeEmail: '修改邮箱',
    changePassword: '修改密码',
    changeUserName: '修改 Matters ID',
    ...
    enterPassword: '请输入密码',
    enterPaymentPasswordAgain: '請再次輸入支付密碼',
    ...
    hintPaymentPassword: '输入六位数字支付密码',
    ...
    successResetPaymentPassword: '支付密码重置成功',
