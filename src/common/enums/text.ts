...
export const TEXT = {
  zh_hant: {
    ...
    hintCircleName: '2-20 個字元，僅支持英文、數字及下劃線',
    hintCircleDisplayName: '2-12 個字元，僅支持中英文或數字',
  ...
  zh_hans: {
    ...
    hintCircleName: '2-20 位，仅支持英文、数字及下划线',
    hintCircleDisplayName: '2-12 位，仅支持中英文或数字',
