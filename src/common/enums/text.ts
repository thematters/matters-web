...
export const TEXT = {
  zh_hant: {
    ...
    addedChapterArticles: '作品已添加到章節',
    addedTopicArticles: '作品已添加到主題',
    addTag: '添加標籤',
    agree: '同意',
    ...
    hintChapterAddArticle: '將章節加入主題。',
    hintTopicAddArticle: '將作品加入主題。',
    ...
    topic: '主题',
    chapterAddArticle: '添加作品到章節',
    topicAddArticle: '添加作品到主題',
    topUp: '儲值',
  ...
  zh_hans: {
    ...
    addedChapterArticles: '作品已添加到章节',
    addedTopicArticles: '作品已添加到主题',
    addTag: '添加标签',
    agree: '同意',
    ...
    hintChapterAddArticle: '将章节加入主题。',
    hintTopicAddArticle: '将作品加入主题。',
  ...
  en: {
    ...
    addedChapterArticles: 'Articles added',
    addedTopicArticles: 'Articles added',
    addTag: 'Add Tag',
    agree: 'Agree',
    ...
    hintChapterAddArticle: 'Adding articles to the chapter',
    hintTopicAddArticle: 'Adding articles to the topic',
    ...
    NOT_ALLOW_ADD_OFFICIAL_TAG: 'Not allow to add official tag',
    ...
    topic: 'Topic',
    chapterAddArticle: 'Add Articles to Chapter',
    topicAddArticle: 'Add Articles to Topic',
    topUp: 'Top Up',
    UNABLE_TO_UPLOAD_FROM_URL:
