...
<p>3.2 為了保護個人信息，MATTERS將要求所有用戶（或如PDPO所定義的其各自相關人員）在請求訪問和/或修改其個人信息時證明其身份。訪問和修改個人信息的請求應當以書面形式提交併發送至ask@matters.news。MATTERS應當收取合理的費用以抵消MATTERS在處理相關數據訪問請求時所產生的管理和實際成本費用。如果有合理的理由相信某個人信息不準確，則MATTERS應當採取可行的措施以確保此個人信息不被使用，除非並且直到這個理由不再適用於此類個人信息或者此個人信息被刪除。</p>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;(i)&nbsp;&nbsp;&nbsp;&nbsp;使用戶能夠訪問和使用服務；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(ii)&nbsp;&nbsp;&nbsp;&nbsp;與用戶溝通，用於包括但不限於關於服務以及處理用戶請求與投訴，向用戶提供技術、管理、運營和帳戶信息；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(iii)&nbsp;&nbsp;&nbsp;&nbsp;聯繫用戶以實施關於用戶服務體驗的調查和客戶評價；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(iv)&nbsp;&nbsp;&nbsp;&nbsp;運營、保護、改進和優化服務，改善與個性化用戶服務體驗；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(v)&nbsp;&nbsp;&nbsp;&nbsp;根據用戶的興趣或其他指示向用戶提供量身定制的內容；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(vi)&nbsp;&nbsp;&nbsp;&nbsp;管理MATTERS的業務，進行與服務相關的新功能、新服務和新應用的研究與開發；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(vii)&nbsp;&nbsp;&nbsp;&nbsp;向用戶發送其可能感興趣的個人資訊、廣告信息以及其他信息（單獨，或者與MATTERS的附屬公司或合作夥伴提供的功能和/或服務和應用一起），此條必須滿足以下條件，即用戶提供了PDPO要求的同意書；</p>
...
<p><b><u>10. 法律免責聲明</u></b></p>

<p>10.1 MATTERS有義務遵守PDPO關於個人信息管理的要求，保護其保有的個人信息的隱私性、機密性和安全性。當受相關法律或法庭判令要求，或者受其他政府或執法機構請求時，MATTERS有可能需要公開個人信息。同樣適用的情況還有，當有理由相信，為了對有意地或無意地對其用戶或其他人造成妨礙的人進行識別、調查、保護、聯絡或起訴，而有必要公開其個人信息時，或者當任何人因其行為而受到傷害時。</p>

<p>10.2 用戶理解並承認，MATTERS從不會以使用服務為理由要求用戶與其他用戶共享其私鑰。</p>

<p>10.3 用戶理解並承認，本隱私政策不適用於任何由用戶通過服務或任何其他方式提供給MATTERS的非強制提供信息。所有非強制提供的信息將被看作非機密信息，MATTERS可以自由地複製、使用、公開和向其他人發送此類信息，沒有限制或歸屬。</p>

<p>10.4 用戶理解並承認，用戶發佈與轉發內容的風險由用戶自己承擔。雖然MATTERS會限制用戶對某些頁面的訪問，但用戶承認沒有任何安全措施是完美的萬無一失的。另外，用戶理解並承認，MATTERS無法控制其用戶選擇與誰共享內容。因此，用戶理解並承認，MATTERS不能也不保證其用戶內容一定不會被未經授權的人瀏覽。</p>
...
<p>3.2 为了保护个人信息，MATTERS将要求所有用户（或如PDPO所定义的其各自相关人员）在请求访问和/或修改其个人信息时证明其身份。访问和修改个人信息的请求应当以书面形式提交并发送至ask@matters.news。MATTERS应当收取合理的费用以抵消MATTERS在处理相关数据访问请求时所产生的管理和实际成本费用。如果有合理的理由相信某个人信息不准确，则MATTERS应当采取可行的措施以确保此个人信息不被使用，除非并且直到这个理由不再适用于此类个人信息或者此个人信息被删除。</p>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;(i)&nbsp;&nbsp;&nbsp;&nbsp;使用户能够访问和使用服务；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(ii)&nbsp;&nbsp;&nbsp;&nbsp;与用户沟通，用于包括但不限于关于服务以及处理用户请求与投诉，向用户提供技术、管理、运营和账户信息；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(iii)&nbsp;&nbsp;&nbsp;&nbsp;联系用户以实施关于用户服务体验的调查和客户评价；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(iv)&nbsp;&nbsp;&nbsp;&nbsp;运营、保护、改进和优化服务，改善与个性化用户服务体验；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(v)&nbsp;&nbsp;&nbsp;&nbsp;根据用户的兴趣或其他指示向用户提供量身定制的内容；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(vi)&nbsp;&nbsp;&nbsp;&nbsp;管理MATTERS的业务，进行与服务相关的新功能、新服务和新应用的研究与开发；</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;(vii)&nbsp;&nbsp;&nbsp;&nbsp;向用户发送其可能感兴趣的个人资讯、广告信息以及其他信息（单独，或者与MATTERS的附属公司或合作伙伴提供的功能和/或服务和应用一起），此条必须满足以下条件，即用户提供了PDPO要求的同意书；</p>
...
<p><b><u>10. 法律免责声明</u></b></p>

<p>10.1 MATTERS有义务遵守PDPO关于个人信息管理的要求，保护其保有的个人信息的隐私性、机密性和安全性。当受相关法律或法庭判令要求，或者受其他政府或执法机构请求时，MATTERS有可能需要公开个人信息。同样适用的情况还有，当有理由相信，为了对有意地或无意地对其用户或其他人造成妨碍的人进行识别、调查、保护、联络或起诉，而有必要公开其个人信息时，或者当任何人因其行为而受到伤害时。</p>

<p>10.2 用户理解并承认，MATTERS从不会以使用服务为理由要求用户与其他用户共享其私钥。</p>

<p>10.3 用户理解并承认，本隐私政策不适用于任何由用户通过服务或任何其他方式提供给MATTERS的非强制提供信息。所有非强制提供的信息将被看作非机密信息，MATTERS可以自由地复制、使用、公开和向其他人发送此类信息，没有限制或归属。</p>
